        ...
        <?php foreach ($grouped as $ownerGroupName => $items): ?>
            ...
            <table>
                <thead>
                    <tr>
                        <th width="4%">#</th>
                        <th class="text-left" width="36%">ชื่อสินค้า</th>
                        <th class="text-left" width="18%">รหัสบาร์โค้ด</th>
                        <th width="12%" title="จำนวนของในตู้/คลัง">🗄️ ในตู้<br><small style="font-weight:400;">(คลัง)</small></th>
                        <th width="12%" title="จำนวนที่วางหน้าร้าน">🏪 หน้าร้าน</th>
                        <th width="10%">รวม</th>
                        <th width="8%">สถานะ</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    foreach ($items as $i => $p):
                        ...
                        } elseif ($p['total_qty'] <= 3) {
                            $badge = '<span class="badge badge-low">ใกล้หมด</span>';
                        } else {
        ...
        <table style="margin-top: 10px; border: 2px solid #1e3a5f;">
            <tfoot>
                <tr style="background: #1e3a5f !important; -webkit-print-color-adjust: exact; print-color-adjust: exact;">
                    ...
                    <td class="text-center" style="color:#93c5fd; font-size:14px; font-weight:700; background:#1e3a5f; width:12%;"><?= number_format($totalStorage) ?></td>
                    <td class="text-center" style="color:#6ee7b7; font-size:14px; font-weight:700; background:#1e3a5f; width:12%;"><?= number_format($totalFront) ?></td>
                    <td class="text-center" style="color:#fde68a; font-size:16px; font-weight:800; background:#1e3a5f; width:10%;"><?= number_format($totalAll) ?></td>
